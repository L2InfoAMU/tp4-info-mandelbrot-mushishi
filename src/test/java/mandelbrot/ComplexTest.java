...
public class ComplexTest {
    ...
    @Test
    void testEquals(){
        assertEquals(true,Complex.ZERO.equals(new Complex(0,0)));
        assertEquals(true,Complex.I.equals(new Complex(0,1)));
        assertEquals(true,Complex.ONE.equals(new Complex(1,0)));
        assertEquals(true,minusI.equals(new Complex(0,-1)));
    ...
    @Test
    void testAdd(){
        assertEquals(new Complex(1,1), Complex.ZERO.add(onePlusI));
        assertEquals(new Complex(0,0), Complex.ZERO.add(Complex.ZERO));
    ...
    void testScale(){
        ...
        assertEquals(Complex.ZERO, Complex.ZERO.scale(10));
        assertEquals(new Complex(10,0), Complex.ONE.scale(10));
    }
}
